...
export let recipes = [
    ...
    },
    {
        ...
        instructions: 'Place egg stand in instant pot, fill with 1 cup water Set to pressure for 7 minutes, then let sit 3 minutes before release',
        category:'Side'
    },
    {
    ...
    },
    {
        ...
        imageSrc:    'Assets\/GrilledCarrots.png',
        description : 'Delightful Vegetable for Summer Grilling',
        ingredients : '4 carrots 1 avacado 1 tablespoon mint Quarter cup Maple Syrup',
        instructions: 'rub carrots in olive oil salt and pepper to taste.  grill for 12 minutes, flipping half way.  Mix with min, maple and sliced avacado',
        category:'Vegetable'
